...
class WorkspaceRules(MappingRule):
    ...
    def __init__(self, *args, **kwargs):
        self.mapping = {
            ...
            _("tabbed layout"): "w-w",
            _("tiling layout"): "w-e",
            _("stacking layout"): "w-s",
            _("kill focused window"): "ws-q",
            _("horizontal split"): "w-h",
            _("vertical split"): "w-v",
            _("toggle floating"): "ws-space",
            _("focus floating"): "w-space",
            _("reload i3 config file"): "ws-c",
            _("restart i3 in place"): "ws-r",
            _("I'm really sure I want to exit i3"): "ws-e",
            _("resize mode"): "w-r",
            _("invert screen rotation"): "ws-a",
            _("reset screen rotation"): "ws-n",
            _("(display|show) window info"): "ws-t",
            }
        self.extras = [
            IntegerRef('n', 1, 13),
            Choice(
